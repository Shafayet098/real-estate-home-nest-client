    ...
    return (
         <section>
            <div className='flex flex-col items-center '>
                <h1 className='text-5xl text-secondary text-center font-semibold mb-3'>Featured Services</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 px-12'>
                <div onMouseEnter={() => setActive(!active)}
                    ...
                    <div class="flex-1">
                        <div class="flex items-start gap-4">
                            <div class={`${active ? 'p-4 rounded-xl bg-primary text-white' : 'bg-green-100 p-4 rounded-xl text-primary'}`}>
                ...
                <div onMouseEnter={() => setActive2(!active2)}
                    ...
                    <div class="flex-1">
                        <div class="flex items-start gap-4">
                            <div class={`${active2 ? 'p-4 rounded-xl bg-primary text-white' : 'bg-green-100 p-4 rounded-xl text-primary'}`}>
                ...
                <div onMouseEnter={() => setActive3(!active3)}
                    ...
                    <div class="flex-1">
                        <div class="flex items-start gap-4">
                            <div class={`${active3 ? 'p-4 rounded-xl bg-primary text-white' : 'bg-green-100 p-4 rounded-xl text-primary'}`}>
                                <BsKey size={40}></BsKey>
                            </div>
                ...
                <div onMouseEnter={() => setActive4(!active4)}
                    ...
                    <div class="flex-1">
                        <div class="flex items-start gap-4">
                            <div class={`${active4 ? ' p-4 rounded-xl bg-primary text-white' : 'bg-green-100 p-4 rounded-xl text-primary'}`}>
