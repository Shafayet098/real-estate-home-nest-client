    ...
    return (
        <div>
            <div className='flex flex-col items-center '>
                <h1 className='text-5xl text-secondary text-center font-semibold mb-3'>Why Us</h1>
                <div className='w-12 h-1 bg-secondary mb-2'></div>
                <p className='text-secondary text-xl'>His needs result from something escape him indeed are consectetur will</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 px-12 mt-6 gap-4">
                <div className="p-2">
                    <div>
                        <h1 className="text-4xl text-secondary">Why Choose Premier Real Estate Partners?</h1>
                        <p className="text-lg mt-4 text-secondary">With over two decades of experience in the real estate market, we've built our reputation on trust, expertise, and exceptional results. Our dedicated team of local experts understands the nuances of every neighborhood and market trend.</p>
                    </div>
                    <div className="flex flex-col gap-4 ">
                        <div className="flex gap-6 mt-6 border-b-2 pb-2 border-slate-200">
                            <div className="bg-primary rounded-full w-18 h-13  text-white flex items-center justify-center">
                                <PiCheckCircleFill size={30}></PiCheckCircleFill>
                            </div>
                            <div>
                                <h1 className="text-secondary text-2xl">Local Market Expertise</h1>
                                <p className="text-lg text-accent">Deep knowledge of neighborhoods, pricing trends, and market conditions in your area.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 mt-6 pb-2 border-slate-200 border-b-2">
                            <div className="bg-primary rounded-full w-18 h-13 text-white flex items-center justify-center">
                                <BsShieldFillCheck size={28}></BsShieldFillCheck >
                            </div>
                            <div>
                                <h1 className="text-secondary text-2xl">Verified Listings Only</h1>
                                <p className="text-lg text-accent">Every property is thoroughly vetted and verified before listing to ensure accuracy and quality.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 mt-6 pb-2 border-slate-200 border-b-2">
                            <div className="bg-primary rounded-full w-18 h-13 text-white flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-accent">Our dedicated support team is available around the clock to assist with your real estate needs.</p>
                            </div>
                        </div>
                        <div className="flex gap-6 mt-6 pb-2 border-slate-200 border-b-2">
                            <div className="bg-primary rounded-full w-18 h-13 text-white flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-accent">Consistently delivering results with over 2,500 successful transactions and 98% client satisfaction.</p>
                            </div>
                        </div>
                    </div>
                </div>
