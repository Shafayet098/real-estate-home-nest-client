            ...
            {slides.map((slide, index) => (
                ...
                >
                    ...
                    <div className="absolute bottom-4 left-8 sm:bottom-8 sm:left-16 text-white flex flex-col sm:flex-row gap-6 items-center">
                        ...
                        <div>
                            <Link class="relative inline-flex items-center justify-center p-3 px-10 py-3  overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-primary rounded-full shadow-md group">
                                ...
                                <span class="absolute flex items-center justify-center text-primary transition-all duration-300 transform group-hover:translate-x-full ease">{slide.button} </span>
